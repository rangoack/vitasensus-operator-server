export const GVITE_EXECUTABLE = process.env.GVITE_EXECUTABLE!;
...
export const VITASENSUS_CONTRACT_ADDRESS = process.env.VITASENSUS_CONTRACT_ADDRESS!;
export const VITE_IPC_URL = process.env.VITE_IPC_URL;
